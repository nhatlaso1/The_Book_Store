        ...
        try {
            if (user == null) {
                ...
                if (statusUser.equals("Active")) {
                    ...
                    String imporDate = request.getParameter("importDate");
                    ...
                    if (check) {
                        BookDTO book = new BookDTO(bookID, title, fileName, description, author, category, status, Float.parseFloat(price), Integer.parseInt(quantity), new Date());
                        ...
                        BookDTO book = new BookDTO(bookID, title, price, description, author, category, status, Integer.parseInt(quantity));
