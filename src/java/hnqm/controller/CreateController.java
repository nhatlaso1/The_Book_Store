    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!password.equals(confirm)) {
                userError.setPasswordError("Hai pass word không giống nhau");
                check = false;
            }
            if (check) {
                UserDAO dao = new UserDAO();
                UserDTO user = new UserDTO(userID, fullName, password, roleID, status, phone);
